...
Última actualización (0.42.0): Plan Cóndor mejora la recuperación durante la revelación, confirma cada cambio de jugada sólo al ser aceptado, muestra los cambios reales de Soplos junto al impacto y deja tres segundos para ver el desenlace antes del regreso de cinco segundos al lobby. Mantiene las correcciones de cadencia, fondo violeta y carga de 0.41.0.
